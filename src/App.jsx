...
function App() {
  ...
  const handleGlobalVoice = (transcript) => {
    ...
    if (lower.includes('check for allergies') || lower.includes('allergy') || lower.includes('allergies') || lower.includes('alergies') || lower.includes('check label') || lower.includes('what allergens') || lower.includes('is this safe') || lower.includes('scan')) {
